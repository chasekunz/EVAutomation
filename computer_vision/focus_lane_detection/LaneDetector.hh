...
typedef struct LaneDetectorConf
{
  ...
  float extendMeanDirAngleThreshold;
    ///Angle threshold from mean direction used for extending (cosine, 1:
  /// most restrictive, 0: most liberal) Back direction only
  float extendMeanDirAngleThresholdBack;
    ///Angle threshold from mean direction used for extending (cosine, 1:
  /// most restrictive, 0: most liberal) Forward direction only
  float extendMeanDirAngleThresholdForward;
